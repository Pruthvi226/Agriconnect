...
(1, 'Ramesh Kumar', 'ramesh@example.com', '{{bcrypt:Farmer@123}}', '9876543210', 'FARMER', 'VERIFIED', NULL, NULL, NULL, NULL, 0, 0.00),
(2, 'Suresh Singh', 'suresh@example.com', '{{bcrypt:Farmer@123}}', '9876543211', 'FARMER', 'VERIFIED', NULL, NULL, NULL, NULL, 0, 0.00),
(3, 'Amit Patel', 'amit@example.com', '{{bcrypt:Farmer@123}}', '9876543212', 'FARMER', 'PENDING', NULL, NULL, NULL, NULL, 0, 0.00),
(4, 'Vikram Yadav', 'vikram@example.com', '{{bcrypt:Farmer@123}}', '9876543213', 'FARMER', 'VERIFIED', NULL, NULL, NULL, NULL, 0, 0.00),
(5, 'Sunil Sharma', 'sunil@example.com', '{{bcrypt:Farmer@123}}', '9876543214', 'FARMER', 'VERIFIED', NULL, NULL, NULL, NULL, 0, 0.00),
(6, 'AgriFoods Ltd', 'contact@agrifoods.com', '{{bcrypt:Buyer@123}}', '8876543210', 'BUYER', 'VERIFIED', NULL, NULL, NULL, NULL, 0, 0.00),
(7, 'FreshFarm Corp', 'sales@freshfarm.com', '{{bcrypt:Buyer@123}}', '8876543211', 'BUYER', 'VERIFIED', NULL, NULL, NULL, NULL, 0, 0.00),
(8, 'GreenOrg Inc', 'info@greenorg.com', '{{bcrypt:Buyer@123}}', '8876543212', 'BUYER', 'PENDING', NULL, NULL, NULL, NULL, 0, 0.00),
(9, 'Dr. Ravi Verma', 'ravi.v@kvk.edu', '{{bcrypt:Expert@123}}', '7876543210', 'AGRI_EXPERT', 'VERIFIED', 'Crop disease, pest management, and cereals', 499.00, 899.00, '["Hindi","English"]', 12, 4.70),
(10, 'Prof. Anita Rao', 'anita.r@uni.edu', '{{bcrypt:Expert@123}}', '7876543211', 'AGRI_EXPERT', 'VERIFIED', 'Soil health, horticulture, and post-harvest', 599.00, 999.00, '["English","Marathi","Hindi"]', 18, 4.85),
(11, 'Admin User', 'admin@agriconnect.com', '{{bcrypt:Admin@123}}', '9000000000', 'ADMIN', 'VERIFIED', NULL, NULL, NULL, '["English","Hindi"]', 0, 0.00),
(12, 'Meena Devi', 'meena@example.com', '{{bcrypt:Farmer@123}}', '9876543215', 'FARMER', 'VERIFIED', NULL, NULL, NULL, NULL, 0, 0.00),
(13, 'Metro Organics', 'orders@metroorganics.com', '{{bcrypt:Buyer@123}}', '8876543213', 'BUYER', 'VERIFIED', NULL, NULL, NULL, NULL, 0, 0.00);
