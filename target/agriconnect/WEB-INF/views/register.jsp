                ...
                <div class="card-body p-4 p-md-5">
                    <form action="${pageContext.request.contextPath}/register" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg bg-light border-0" name="fullName" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted fw-bold">Username</label>
                            <input type="text" class="form-control form-control-lg bg-light border-0" name="username" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select form-select-lg bg-light border-0" name="roleType" required>
                                <option value="FARMER">Farmer (Producer)</option>
                                <option value="BUYER">Buyer (Business Entity)</option>
                                <option value="EXPERT">Agri-Expert (KVK/University)</option>
                            </select>
                        </div>
                        <button type="submit" class="btn btn-success btn-lg w-100 rounded-pill fw-bold shadow-sm">Complete Registration</button>
                    </form>
                    <div class="text-center mt-4">
                        <p class="text-muted">Already have an account? <a href="${pageContext.request.contextPath}/login" class="text-success fw-bold text-decoration-none">Login here</a></p>
                    </div>
                </div>
            </div>
        </div>
